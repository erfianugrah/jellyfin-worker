...
const cacheAssets = [
    ...
    {asset: 'image', key: queryCacheKey, regex: /^.*\.(jpeg|jpg|png|dng|tiff|webp|gif)/, info: 0, ok: 3600, redirects: 30, clientError: 10, serverError: 0 } || {asset: 'image', key: queryCacheKey, regex: /^.*(\/Images)/, info: 0, ok: 3600, redirects: 30, clientError: 10, serverError: 0 } ,
